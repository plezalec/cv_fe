...
export class HorizontalScroll implements AfterViewInit, OnDestroy {
  ...
  images = [    
'xai-tmp-imgen-2bdcfbd2-abfd-4cb9-ab3d-13eb2eddc2a0.webp','xai-tmp-imgen-4bdc88b0-1568-4811-8803-ae5a504deb36.webp',
...
'xai-tmp-imgen-fb824d6d-f8ea-4655-a06c-7dca41f1714e.webp'
  ...
  loopedImages = [...this.images, ...this.images]; // Infinite trick
